...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_courseworkInput2 p_courseworkInput2;
        ...
        public static SteamVR_Input_ActionSet_courseworkInput2 courseworkInput2
        {
            get
            {
                return SteamVR_Actions.p_courseworkInput2.GetCopy<SteamVR_Input_ActionSet_courseworkInput2>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_courseworkInput2 = ((SteamVR_Input_ActionSet_courseworkInput2)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_courseworkInput2>("/actions/courseworkInput2")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.courseworkInput2};
        }
    }
}
